...
vim.keymap.set('n', '<leader>fh', builtin.command_history, {desc = "command_history"})
...
vim.keymap.set('n', '<leader>ga', builtin.git_commits, {desc = "git_commits"})
...
vim.keymap.set('n', '<leader>fw', ':Telescope fd cwd=~/Rsync/wiki/content/md <CR>', {desc = "wiki search"})
